...
@section('content')
    <div class="max-w-xl mx-auto py-20 text-center">
        ...
        <div class="bg-[#15151B] border border-[#27272A] rounded-xl p-6 mb-6 shadow-xl">
            ...
            <button onclick="copyKey()" class="bg-[#9333EA] px-5 py-2 rounded-lg hover:bg-[#7E22CE] transition">
                Copy License
            </button>

        </div>

        <a href="/licenses" class="inline-block mt-4 text-sm text-gray-400 hover:text-white">
            Lihat semua license →
        </a>
